                                    ...
                                    <div class=" col-sm-12">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group {{ $errors->has('company_name') ? 'has-error' : ''}}">
                                                <input type="text" name="company_name" id="company_name"
                                                       value="{{$user->company_name or ''}}" placeholder="Company Name"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group {{ $errors->has('zip_code') ? 'has-error' : ''}}">
                                                <input type="text" name="zip_code" value="{{$user->zip_code or ''}}"
                                ...
                                <tr id="cart_product_{{$cartItem->id}}">
                                    <td class="cart_product">
                                        <a href="#"><img class="index_img"
                                                         src="{{asset('img/product/'.$cartItem->options->image)}}"
                                                         alt=""></a>
                                    </td>
                                    ...
                                    <td class="cart_quantity">
                                        <div class="cart_quantity_button" id="{{"qty_".$cartItem->id}}"
                                             data-quantity="{{$cartItem->qty}}" data-id="{{$cartItem->id}}"
                                             data-rowid="{{$cartItem->rowId}}" data-price={{$cartItem->price}}>
                                            <input type="text" class="qty cart_quantity_input" name="quantity"
                                                   value="{{$cartItem->qty}}" min="1" size="2" id="number" readonly/>
                                        </div>
                                    </td>
                                    <td class="cart_total">
                                        <p id={{"subtotal_".$cartItem->id}} class="cart_total_price">
                                            ${{$cartItem->subtotal}}</p>
                                    </td>
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <span class="input-group-btn" id="coupon_button">
                                                <button class="btn btn-sm" type="button" id="apply_coupon"
                                                        data-total="{{$total}}"><i class="glyphicon glyphicon-ok "></i></button>
                                        </span>
                                    </div>
                                </td>
                                <td colspan="4">&nbsp;</td>
                                <td colspan="2">
                                    <table class="table table-condensed total-result order-amount">
                                        ...
                                        <tr class="shipping-cost">
                                            ...
                                            <td id="shipping_cost"
                                                data-shipping_cost="{{$shipping_cost }}">{{ $shipping_cost== 0 ?  "Free" : "$".$shipping_cost }}</td>
                                        </tr>
                                        <tr>
                                            <td>Total</td>
                                            @php $finalTotal = $total + ($shipping_cost == "Free" ? 0 : $shipping_Tax) + $discount @endphp
                                            <td id="finalTotal" data-finalTotal="{{$finalTotal}}">
                                                <span>{{ "$".$finalTotal  }}</span></td>
                                        </tr>
