                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="company_name" id="company_name" value="{{$user_address['company_name']}}" placeholder="Company Name" class="checkout-form-input">
                                <input type="text" name="email" value="{{$user_address->email}}" placeholder="Email*" class="checkout-form-input">
                                <input type="text" name="title" value="{{$user_address->title}}" placeholder="Title" class="checkout-form-input">
                                <input type="text" name="first_name" value="{{$user_address->first_name}}" placeholder="First Name *" class="checkout-form-input">
                                <input type="text" name="middle_name" value="{{$user_address->middle_name}}" placeholder="Middle Name" class="checkout-form-input">
                                <input type="text" name="last_name" value="{{$user_address->last_name}}" placeholder="Last Name *" class="checkout-form-input">
                                </div>
                            <div class="col-sm-6">
                                <input type="text" name="address1" value="{{$user_address->address1}}" placeholder="Address 1 *" class="checkout-form-input">
                                @if($user_address->address2)
                                <input type="text" name="address2" value="{{$user_address->address2}}" placeholder="Address 2" class="checkout-form-input">
                                @endif
                                <input type="text" name="city" value="{{$user_address->city}}" placeholder="City *" class="checkout-form-input">
