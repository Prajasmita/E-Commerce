            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading col-md-11"><strong>Order Details : {{'ORD'.str_pad($order_review_page['payment_details']['id'],'4','0',STR_PAD_LEFT)}}</strong></div>
                        ...
                        <div class="panel-body" >
                            ...
                            <div class=" table-responsive user_info">
                                <table class="pull-right">
                                    <tr>
                                        <td> <h4><strong>{{$order_review_page['user_info']['first_name']}} {{$order_review_page['user_info']['middle_name']}} {{$order_review_page['user_info']['last_name']}} </strong></h4></td>
                                    </tr>
                                    <tr>
                                            ...
                                            <tr id=""  >
                                                ...
                                                <td class="cart_quantity">
                                                    <div class="cart_quantity_button" >
                                                        <input type="text" class="qty text-center cart_quantity_input"  name="quantity" value="{{$order_product['quantity']}}" min="1"  size="2" id="number" readonly/>
                                                    </div>
                                                </td>
                                                <td class="cart_total">
