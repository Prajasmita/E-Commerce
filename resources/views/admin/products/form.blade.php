...
<div class="form-group {{ $errors->has('image_name') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
      {{--  {!! Form::file('image_name', array('class' => 'form-control', 'accept' =>'.jpg')) !!}
        ...
        <input class="form-control" name="image_name[]" type="file" id="image_name" value="{{ $product->image_name or ''}}" multiple>

        {!! $errors->first('image_name', '<p class="help-block">:message</p>') !!}
    </div>
    {{--<div class="form-group {{ $errors->has('status') ? 'has-error' : ''}}">

        <label for="status" class="col-md-4 control-label">{{ 'Image status' }}</label>
        <div class="col-md-6">
...
<div class="form-group {{ $errors->has('meta_discription') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <textarea class="form-control" rows="5" name="meta_discription" type="textarea" id="meta_discription" >{{ $product->meta_discription or ''}}</textarea>
...
<div class="form-group {{ $errors->has('meta_keyword') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="meta_keyword" type="text" id="meta_keyword" value="{{ $product->meta_keyword or ''}}" >
