                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a href="{{route('address.delete',$user_address->id)}}" type="button" class="btn btn-danger btn-sm delete_address" id="delete_address"  data-id="{{$user_address->id}}"><i class=" glyphicon glyphicon-trash">Delete</i></a>
                                        @endif
                                    </td>
                                </tr>
                            </table>
