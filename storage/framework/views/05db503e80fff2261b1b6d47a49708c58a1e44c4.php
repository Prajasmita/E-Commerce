    ...
    <section id="cart_items">
        <div class="container">
            <?php if( session()->has('payment_message') ): ?>
                <div class="alert alert-success"><?php echo e(session()->get('payment_message')); ?></div>
            <?php endif; ?>
            ...
            <div class="user_info">
                <table class="pull-right">
                    <tr>
                        <td><strong><h4><?php echo e($order_review_page['user_info']['first_name']); ?> <?php echo e($order_review_page['user_info']['middle_name']); ?> <?php echo e($order_review_page['user_info']['last_name']); ?><h4><strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td> <?php echo e($order_review_page['user_info']['address1']); ?>,<?php echo e($order_review_page['user_info']['address2'] ? $order_review_page['user_info']['address2'] :''); ?></td>
                    </tr>
                    <tr>
                        <td> <?php echo e($order_review_page['user_info']['city']); ?>,<?php echo e($order_review_page['user_info']['zip_code']); ?></td>
                    </tr>
                    <tr>
                        <td> <?php echo e($order_review_page['user_info']['state']); ?>,<?php echo e($order_review_page['user_info']['country']); ?></td>
                    </tr>
                    <tr>
                        <td>Payment Status : <?php echo e($order_review_page['payment_details']['status'] == 'O' ? 'Processing' : 'Pending'); ?></td>
                    </tr>
                </table>
            </div>
                        ...
                        <?php $__currentLoopData = $order_review_page['order_products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr id=""  >
                                <td class="cart_product">
                                    <a href="#"><img class="index_img" src="<?php echo e(asset('img/product/'.$order_product['image_name'])); ?>" alt=""></a>
                                </td>
