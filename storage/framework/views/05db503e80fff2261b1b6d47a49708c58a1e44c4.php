        ...
        <div class="container">
            ...
            <div class="user_info">
                <table class="pull-right">
                    <tr>
                        <td><strong>
                                <h4><?php echo e($order_review_page['user_info']['first_name']); ?> <?php echo e($order_review_page['user_info']['middle_name']); ?> <?php echo e($order_review_page['user_info']['last_name']); ?></h4>
                            </strong></td>
                    </tr>
                    <tr>
