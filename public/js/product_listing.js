...
*/
        ...
        "rowCallback": function( row, data, index ) {
            ...
            $('td:eq(4)', row).html(
                ...
                '<a href="'+DeleteUrl+'"   title="Delete product"><button type="submit" class="btn btn-danger btn-xs" title="Delete User" onclick="return confirm(&quot;Confirmdelete?&quot;)"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</button></a>');
        }
    });
})
